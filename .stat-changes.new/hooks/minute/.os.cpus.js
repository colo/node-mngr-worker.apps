...
var debug = require('debug')('Server:Apps:Stat:Hook:Minute:OS:CPUS');
var debug_internals = require('debug')('Server:Apps:Stat:Hook:Minute:OS:CPUS:Internals');
...
module.exports = {
  cpus: {
    ...
    value: function(entry_point, timestamp, value, key){
      ...
      //
      //   entry_point[key][core][timestamp] = cpu
      // });//iterate on each core
      if(!entry_point[key * 1]) entry_point[key * 1] = {}
      entry_point[key * 1][timestamp] = value
  ...
  //     debug('doc %o %o %s', entry_point, value, key)
  //     process.exit(1)
  //
  //     let speed = {};
  //     let times = {};
