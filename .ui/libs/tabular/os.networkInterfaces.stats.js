...
let debug = require('debug')('mngr-ui-admin:apps:hosts:libs:tabular:os.networkInterfaces.stats'),
    debug_internals = require('debug')('mngr-ui-admin:apps:hosts:libs:tabular:os.networkInterfaces.stats:Internals')


let chart = require('mngr-ui-admin-charts/os/networkInterfaces_stats')
...
let match = /^os\.networkInterfaces\.stats$/
