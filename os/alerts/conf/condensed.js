  ...
  **/
  ...
  'tabular[].%hosts.os.loadavg': {
    '$payload': {
        '$extra': {
          'tabular[].%hosts.os.minute.loadavg': (value, payload) => {
            ...
            // console.log('$playload tabular[].%hosts.os.minute.loadavg', value, result)
    ...
    '$callback': (value, payload) => {
      ...
      let last_minute_loadavg = undefined
      ...
      **/
        ...
        Array.each(extra, function(loadavg_median){
          if(loadavg_median && loadavg_median.property){
            ...
            if(extra_host == host && loadavg_median.value.length > 0) //extra.value = [timestamp,loadavg]
              last_minute_loadavg = loadavg_median.value[1]
          }
        })

      })

      if(last_minute_loadavg && loadavg > (last_minute_loadavg + LOADAVG_THRESHOLD))
      ...
      // console.log('tabular[].%hosts.os.loadavg alert', payload.extra,
      //   last_minute_loadavg,
      //   loadavg,
      // )
...
**/
  ...
  'tabular[].%hosts.os.minute.loadavg': {
    ...
    '$callback': (value, payload) => {
      ...
      **/
      ...
      // console.log('tabular[].%hosts.os.minute.loadavg alert', payload.extra,
      //   last_hour_loadavg,
      //   last_minute_loadavg
      // )
  ...
  'tabular[].%hosts.os.minute.cpus_percentage': {
    ...
    '$callback': (value, payload) => {
      ...
      **/
      ...
      // console.log('tabular os.minute.cpus_percentage alert', value, payload.extra[0].value)
    }
  },
  ...
  */
  ...
  'tabular[].%hosts.os.hour.loadavg': (value, payload) => {
    ...
    console.log('tabular[].%hosts.os.hour.loadavg alert', value, payload)
  ...
  'tabular[].%hosts.os.hour.freemem': {
    ...
    '$callback': (value, payload) => {
      ...
      **/
      ...
      // console.log('tabular tabular[].%hosts.os.hour.freemem alert', value, payload, totalmem)
    },
  },
