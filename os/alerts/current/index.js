...
var debug = require('debug')('Server:Apps:OSAlerts');
var debug_internals = require('debug')('Server:Apps:OSAlerts:Internals');
var debug_events = require('debug')('Server:Apps:OSAlerts:Events');
...
module.exports = new Class({
  ...
  initialize: function(options){
		...
		this.log('os-alerts', 'info', 'os-alerts started');
