...
var debug = require('debug')('Server:Apps:OS:Historical:Minute:Hook:OS:Procs');
var debug_internals = require('debug')('Server:Apps:OS:Historical:Minute:Hook:OS:Procs:Internals');
  ...
  proc: {
    ...
    value: function(entry_point, timestamp, value, key){
      ...
      // Object.each(value, function(proc, pid){
        ...
        entry_point[prop][timestamp] = data
    ...
    doc: function(entry_point, value, key){
      ...
      // })
      // debug_internals('os.procs value %s %o', key, entry_point[key])
