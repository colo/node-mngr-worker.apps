var debug = require('debug')('Server:Apps:OS:Historical:Minute:Filter');
var debug_internals = require('debug')('Server:Apps:OS:Historical:Minute:Filter:Internals');
...
module.exports = function(doc, opts, next){
	...
	// debug_internals('filter doc %o', doc);
	...
	try{
		if(
			...
			Array.each(doc, function(d){
				// let data = JSON.decode(decompress(d.data, {inputEncoding: "Base64"}))
				// let data = decompress(d.data)
