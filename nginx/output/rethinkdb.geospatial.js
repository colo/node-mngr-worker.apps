...
var debug = require('debug')('Server:Apps:Nginx:Output:RethinkDBGeoSpatial');
var debug_events = require('debug')('Server:Apps:Nginx:Output:RethinkDBGeoSpatial:Events');
var debug_internals = require('debug')('Server:Apps:Nginx:Output:RethinkDBGeoSpatial:Internals');
  ...
  _save_docs: function(doc, index){
    ...
    Array.each(doc, function(d, d_index){
      ...
      if(d.data.geoip.location && d.data.geoip.location.latitude && d.data.geoip.location.longitude)
        d.metadata.location = this.r.point(d.data.geoip.location.longitude, d.data.geoip.location.latitude)
