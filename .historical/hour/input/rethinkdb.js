...
var debug = require('debug')('Server:Apps:Historical:Hour:Input');
var debug_internals = require('debug')('Server:Apps:Historical:Hour:Input:Internals');
var debug_events = require('debug')('Server:Apps:Historical:Hour:Input:Events');
...
module.exports = new Class({
				...
				// },
        {
          ...
          search_paths: function(req, next, app){
            ...
            app.reduce({
              ...
              between(
                Date.now() - DAY,//last day should be enough
                Date.now(),
                {index: 'timestamp'}
              ).
              map(function(doc) {
  ...
  initialize: function(options){
		...
		this.log('historical-hour', 'info', 'historical-hour started');
