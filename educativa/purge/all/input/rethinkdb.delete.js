...
let debug = require('debug')('Server:Apps:Educativa:Purge:All:Input'),
    debug_internals = require('debug')('Server:Apps:Educativa:Purge:All:Input:Internals');
      ...
      periodical: [
        ...
        **/
        ...
        //     // } //req.query.register === false
				...
				// },
        {
        	range_delete: function(req, next, app){
            let end = roundSeconds(Date.now() - 5 * MINUTE)

            debug('range delete %s', new Date(end))

            app.fireEvent('onRange', {
              id: "range",
              Range: "posix 0-"+end+"/*",
              query: {
                index: false,
