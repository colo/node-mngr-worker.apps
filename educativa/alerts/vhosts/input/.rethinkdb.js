...
let debug = require('debug')('Server:Apps:Educativa:Checks:Vhosts:Input'),
    debug_internals = require('debug')('Server:Apps:Educativa:Checks:Vhosts:Input:Internals');
...
module.exports = new Class({
  ...
  initialize: function(options){
    ...
    // this.register_on_changes.bind(this)
		...
		this.profile('Server:Apps:Educativa:Checks:Vhosts:Input_init');//start profiling


		this.profile('Server:Apps:Educativa:Checks:Vhosts:Input_init');//end profiling

		this.log('Server:Apps:Educativa:Checks:Vhosts:Input', 'info', 'Server:Apps:Educativa:Checks:Vhosts:Input started');
  },
