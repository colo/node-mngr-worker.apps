...
var debug = require('debug')('Server:Apps:Historical:Hour:Hook:OS:NetworkInterfaces');
var debug_internals = require('debug')('Server:Apps:Historical:Hour:Hook:OS:NetworkInterfaces:Internals');
