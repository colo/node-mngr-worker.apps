...
var debug = require('debug')('Server:Apps:Stat:Hook:Day:Logs:Qmail:Send:Status');
var debug_internals = require('debug')('Server:Apps:Stat:Hook:Day:Logs:Qmail:Send:Status:Internals');
